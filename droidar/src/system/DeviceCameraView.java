...
public class DeviceCameraView extends CameraView {
	private static final String LOG_TAG = "DeviceCameraView";
	SurfaceHolder mHolder;
	Camera myCamera;
	
	public DeviceCameraView(Context context) {
		super(context);
		intiCameraView(context);
	}
	
	public DeviceCameraView(Context context, AttributeSet attrs) {
		super(context, attrs);
		intiCameraView(context);
