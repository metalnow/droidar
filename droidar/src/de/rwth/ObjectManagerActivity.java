...
import telemetry.OPTelemetryService.LocalBinder;
import telemetry.OPTelemetryService.TelemTask;
...
//	private static boolean WARN = LOGLEVEL > 1;
	...
	public void onStart() {
		...
		Intent intent = new Intent(getApplicationContext(),
				telemetry.OPTelemetryService.class);
		if (DEBUG)
